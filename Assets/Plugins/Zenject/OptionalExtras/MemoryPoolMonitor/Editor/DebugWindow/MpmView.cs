...
namespace Zenject.MemoryPoolMonitor
{
    ...
    #region Public Methods
        ...
        public void GuiRender()
        {
            ...
            GUI.Label(new Rect(
                          0 , 0 , _settings.FilterPaddingLeft , _settings.FilterHeight) , "Filter:" ,
            ...
            Rect viewArea = new Rect(0 , HeaderTop , TotalWidth - scrollbarSize.y ,
    ...
    #region Private Methods
        ...
        void DrawColumnHeader(int index , Rect bounds , string text)
        {
            ...
            if (_sortColumn == index)
            {
                ...
                GUI.DrawTexture(new Rect(bounds.x + offset.x , bounds.y + offset.y , image.width , image.height) ,
                                image);
            }
        ...
        {
            GUI.DrawTexture(new Rect(
                                0 , _settings.FilterHeight - 0.5f * _settings.SplitterWidth , width ,
                                _settings.SplitterWidth) , LineTexture);

            GUI.DrawTexture(new Rect(
                                0 , HeaderTop - 0.5f * _settings.SplitterWidth , width , _settings.SplitterWidth) ,
                            LineTexture);
